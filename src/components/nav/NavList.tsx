...
function NavList({
	...
	return (
		<>
			<ul className="flex flex-col lg:flex-row w-full lg:gap-[15px] ">
				{navList.map(link => (
					<NavLink
						key={link.linkName}
						name={link.linkName}
				...
				<li
					className={`w-full flex lg:hidden flex-col  overflow-hidden duration-500 relative  transition-all lg:opacity-100 lg:translate-y-0 lg:delay-0 ${!isExpanded ? 'opacity-0  -translate-y-4 delay-200' : 'opacity-100 translate-y-0 delay-500'}`}>
					<button
						...
						<svg
							...
							className={`transition-transform duration-300 ${isSocialOpen ? 'rotate-180' : 'rotate-0'}`}>
							<path
					...
					<div
						...
						<Link
							...
							<svg
								...
								xmlns="http://www.w3.org/2000/svg">
								<path
									d="M16 8.04889C16 3.60361 12.4183 0 8.00001 0C3.58172 0 0 3.60361 0 8.04889C0 12.0663 2.92548 15.3962 6.75 16V10.3755H4.71875V8.04889H6.75V6.27562C6.75 4.25836 7.94434 3.1441 9.77172 3.1441C10.647 3.1441 11.5625 3.3013 11.5625 3.3013V5.28208H10.5537C9.55992 5.28208 9.25001 5.90253 9.25001 6.53906V8.04889H11.4688L11.1141 10.3755H9.25V16C13.0745 15.3962 16 12.0663 16 8.04889Z"
									fill="#565656"
								/>
							</svg>
							Facebook
...
const NavLink = ({
	...
	return (
		<li
			className={`w-full flex  overflow-hidden duration-500 relative  transition-all lg:opacity-100 lg:translate-y-0 lg:delay-0 ${!isExpanded ? 'opacity-0  -translate-y-4 delay-300' : 'opacity-100 translate-y-0 delay-400'}`}>
			<Link
				href={href}
				className={`text-sm block leading-5 font-medium bg-transparent duration-300 transition-all w-full lg:w-fit lg:hover:bg-grayscale-100 lg:px-4 py-2.5 lg:rounded-[500px] ${isActive ? 'text-black-primary' : 'text-grayscale-500'}`}>
				{name}
			</Link>
		</li>
	)
